		...
		<div id="site_content">
			...
			<div id="content">
				<%
					...
					FileInputStream fis=new FileInputStream("F:\\"+fname);
				...
				%>
				<form action="upload" name="name" method="post" onsubmit="return validation()">
					...
					%>
							...
							<textarea name="content"
								style="width: 400px; height: 400px; position: relative; left: 250px;"><%=blo%></textarea>
					<%
							j++;
						}
					%>
					...
					<pre>
		                  <input type="submit" id="but" value="Upload" />
					</pre>

		...
		<div id="site_content">
			<div id="content">
				<fieldset style="background-color: activeborder;">
					<center>
						<h2 class="title" style="color: black">USER REGISTRATION</h2>
					</center>
					...
					<form action="registration" name="ureg"
						...
						&nbsp;<input type="submit" id="but" value="Register"
							style="background-color: #71c24a; color: #ffffff" />
						&nbsp;&nbsp; <input type="reset" id="but" value="Reset"
							style="background-color: #71c24a; color: #ffffff"></input><br></br>
							<font style="font-size: 17px;"> Existing User <a
								href="user.jsp" style="color: cadetblue">Login here</a>
							</font>
					</form>
				</fieldset>
			</div>

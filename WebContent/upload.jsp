	...
	<div id="main">
		...
		<div id="site_content">
			...
			<div id="content">
				...
				%>
				<h2>Welocme ! <font style="color: tomato"> <%=name%></font>
				</h2>
				<form action="AddFileServlet" name="name" method="post"
					enctype="multipart/form-data" >					
					<table align="relative" >
						<tr>
							<td>Select File :</td>
						...
						<tr>
							...
							style="background-color: #71c24a" value="Upload"></td>
							<td><input
							type="reset" id="but" style="background-color: #71c24a"
							value="Reset"></td>
						</tr>
					</table>
				</form>
